...
import '/index.dart';
import 'admin_calendar_cancelled_widget.dart' show AdminCalendarCancelledWidget;
...
class AdminCalendarCancelledModel
    extends FlutterFlowModel<AdminCalendarCancelledWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-calendar-cancelled widget.
