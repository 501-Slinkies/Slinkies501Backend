...
import 'dart:ui';
import '/index.dart';
import 'admin_calllogs_widget.dart' show AdminCalllogsWidget;
...
class AdminCalllogsModel extends FlutterFlowModel<AdminCalllogsWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in admin-calllogs widget.
