...
import 'admin_allusers_model.dart';
export 'admin_allusers_model.dart';

/// (NOT USED)
class AdminAllusersWidget extends StatefulWidget {
  const AdminAllusersWidget({super.key});

  static String routeName = 'admin-allusers';
  static String routePath = '/adminAllusers';

  @override
  State<AdminAllusersWidget> createState() => _AdminAllusersWidgetState();
}

class _AdminAllusersWidgetState extends State<AdminAllusersWidget> {
  late AdminAllusersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAllusersModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VolunteersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VolunteersRecord> adminAllusersVolunteersRecordList =
            snapshot.data!;
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final volunteers =
                                                            adminAllusersVolunteersRecordList
                                                                .toList();
