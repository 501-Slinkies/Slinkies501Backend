...
import 'admin_calendar_complete_model.dart';
export 'admin_calendar_complete_model.dart';

class AdminCalendarCompleteWidget extends StatefulWidget {
  const AdminCalendarCompleteWidget({super.key});

  static String routeName = 'admin-calendar-complete';
  static String routePath = '/admin-calendar-complete';

  @override
  State<AdminCalendarCompleteWidget> createState() =>
      _AdminCalendarCompleteWidgetState();
}

class _AdminCalendarCompleteWidgetState
    extends State<AdminCalendarCompleteWidget> {
  late AdminCalendarCompleteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCalendarCompleteModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final adminCalendarCompleteGetCalendarInfoResponse = snapshot.data!;
                                        ...
                                        Container(
                                          ...
                                          child: custom_widgets
                                            ...
                                            apiEventList: GetCalendarInfoCall
                                                    .ridesList(
                                              adminCalendarCompleteGetCalendarInfoResponse
                                                  .jsonBody,
                                            )!
                                                .where((e) =>
