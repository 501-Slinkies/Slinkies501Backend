...
import 'available_drivers_widget.dart' show AvailableDriversWidget;
...
class AvailableDriversModel extends FlutterFlowModel<AvailableDriversWidget> {
  ///  Local state fields for this component.

  List<String> listOfDriverUID = [];
  void addToListOfDriverUID(String item) => listOfDriverUID.add(item);
  void removeFromListOfDriverUID(String item) => listOfDriverUID.remove(item);
  void removeAtIndexFromListOfDriverUID(int index) =>
      listOfDriverUID.removeAt(index);
  void insertAtIndexInListOfDriverUID(int index, String item) =>
      listOfDriverUID.insert(index, item);
  void updateListOfDriverUIDAtIndex(int index, Function(String) updateFn) =>
      listOfDriverUID[index] = updateFn(listOfDriverUID[index]);

  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Firestore Query - Query a collection] action in available-drivers widget.
  DestinationRecord? addressQuery;
  // Stores action output result for [Firestore Query - Query a collection] action in available-drivers widget.
  ClientsRecord? clientQuery;
  // Stores action output result for [Custom Action - getClientRecord] action in available-drivers widget.
  DocumentReference? clientDetails;
  // Stores action output result for [Firestore Query - Query a collection] action in available-drivers widget.
  ClientsRecord? actualClientDetails;
  // Stores action output result for [Custom Action - getDestinationRecord] action in available-drivers widget.
  ...
  // Stores action output result for [Backend Call - API (setDriver)] action in Button widget.
  ApiCallResponse? apiResultzv0;
