...
import 'dart:ui';
import '/index.dart';
import 'admin_security_definitions_widget.dart'
...
class AdminSecurityDefinitionsModel
    extends FlutterFlowModel<AdminSecurityDefinitionsWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-security_definitions widget.
  ...
  // State field(s) for role_name widget.
  FocusNode? roleNameFocusNode;
  TextEditingController? roleNameTextController;
  String? Function(BuildContext, String?)? roleNameTextControllerValidator;
  // Stores action output result for [Backend Call - API (postRoles)] action in Button widget.
  ApiCallResponse? apiResultm14;
  // Stores action output result for [Backend Call - API (getRoles)] action in Button widget.
  ApiCallResponse? apiResultdu8;
  // State field(s) for parent_variable widget.
  FormFieldController<String>? parentVariableValueController;
  ...
  void dispose() {
    ...
    roleNameFocusNode?.dispose();
    roleNameTextController?.dispose();
  }

  /// Additional helper methods.
  String? get parentVariableValue => parentVariableValueController?.value;
}
