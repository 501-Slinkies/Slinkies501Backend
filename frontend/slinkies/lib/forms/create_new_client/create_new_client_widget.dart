...
import 'create_new_client_model.dart';
export 'create_new_client_model.dart';

class CreateNewClientWidget extends StatefulWidget {
  const CreateNewClientWidget({super.key});

  @override
  State<CreateNewClientWidget> createState() => _CreateNewClientWidgetState();
}

class _CreateNewClientWidgetState extends State<CreateNewClientWidget> {
  late CreateNewClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewClientModel());
    ...
    _model.adress1TextController ??= TextEditingController();
