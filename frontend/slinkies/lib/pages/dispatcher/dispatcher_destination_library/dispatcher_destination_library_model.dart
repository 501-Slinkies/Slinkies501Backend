...
import 'dart:ui';
import '/index.dart';
import 'dispatcher_destination_library_widget.dart'
...
class DispatcherDestinationLibraryModel
    extends FlutterFlowModel<DispatcherDestinationLibraryWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in dispatcher-destination_library widget.
