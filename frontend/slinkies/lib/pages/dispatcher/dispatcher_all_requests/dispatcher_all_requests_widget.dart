...
import '/modals/sure_delete_request/sure_delete_request_widget.dart';
...
import 'dispatcher_all_requests_model.dart';
export 'dispatcher_all_requests_model.dart';

class DispatcherAllRequestsWidget extends StatefulWidget {
  const DispatcherAllRequestsWidget({super.key});

  static String routeName = 'dispatcher-all_requests';
  static String routePath = '/dispatcher-all_requests';

  @override
  State<DispatcherAllRequestsWidget> createState() =>
      _DispatcherAllRequestsWidgetState();
}

class _DispatcherAllRequestsWidgetState
    extends State<DispatcherAllRequestsWidget> {
  late DispatcherAllRequestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherAllRequestsModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.roleDropDownValue == 'Super-Admin') {
        context.pushNamed(
          SuperAdminDashboardWidget.routeName,
      ...
      } else if (_model.roleDropDownValue == 'Admin') {
        context.pushNamed(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RidesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RidesRecord> dispatcherAllRequestsRidesRecordList = snapshot.data!;
                                                                        ...
                                                                        () async {
                                                                          safeSetState(
                                                                            ...
                                                                            _model.simpleSearchResults1 =
                                                                                TextSearch(
                                                                              dispatcherAllRequestsRidesRecordList
                                                                                  .map(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onFieldSubmitted:
                                                                      ...
                                                                      safeSetState(
                                                                          () {
                                                                        _model
                                                                            .simpleSearchResults3 = TextSearch((List.generate(
