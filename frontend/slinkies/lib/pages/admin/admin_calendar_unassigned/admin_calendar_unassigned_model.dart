...
import '/index.dart';
import 'admin_calendar_unassigned_widget.dart'
...
class AdminCalendarUnassignedModel
    extends FlutterFlowModel<AdminCalendarUnassignedWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-calendar-unassigned widget.
