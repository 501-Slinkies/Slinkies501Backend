...
import 'dispatcher_calllogs_model.dart';
export 'dispatcher_calllogs_model.dart';

class DispatcherCalllogsWidget extends StatefulWidget {
  const DispatcherCalllogsWidget({super.key});

  static String routeName = 'dispatcher-calllogs';
  static String routePath = '/dispatcher-calllogs';

  @override
  State<DispatcherCalllogsWidget> createState() =>
      _DispatcherCalllogsWidgetState();
}

class _DispatcherCalllogsWidgetState extends State<DispatcherCalllogsWidget> {
  late DispatcherCalllogsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherCalllogsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CalllogsRecord>>(
      stream: queryCalllogsRecord(
        limit: 20,
      ),
      builder: (context, snapshot) {
        ...
        List<CalllogsRecord> dispatcherCalllogsCalllogsRecordList =
            snapshot.data!;
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  ...
                                  child: NavButtonWidget(
                                    ...
                                    destination: () async {
                                      context.pushNamed(
                                          DispatcherCalllogsWidget.routeName);
                                    },
                                  ),
                                ),
                                wrapWithModel(
                                                                        ...
                                                                        () async {
                                                                          safeSetState(
                                                                            ...
                                                                            _model.simpleSearchResults1 =
                                                                                TextSearch(
                                                                              dispatcherCalllogsCalllogsRecordList
                                                                                  .map(
                                                                                    (record) => TextSearchItem.fromTerms(record, [
                                                                                      record.firstName!,
                                                                                      record.lastName!,
                                                                                      record.phoneNumber!,
                                                                                      record.forwardedToNameAndDate!
                                                                                    ]),
                                                                                  )
                                                                                  .toList(),
