...
import '/index.dart';
import 'admin_calendar_assigned_widget.dart' show AdminCalendarAssignedWidget;
...
class AdminCalendarAssignedModel
    extends FlutterFlowModel<AdminCalendarAssignedWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-calendar-assigned widget.
