...
import '/forms/available_drivers/available_drivers_widget.dart';
...
import '/forms/view_ride/view_ride_widget.dart';
...
import 'admin_all_requests_model.dart';
export 'admin_all_requests_model.dart';

/// Admin main menu page
///
class AdminAllRequestsWidget extends StatefulWidget {
  const AdminAllRequestsWidget({super.key});

  static String routeName = 'admin-all_requests';
  static String routePath = '/admin-all_requests';

  @override
  State<AdminAllRequestsWidget> createState() => _AdminAllRequestsWidgetState();
}

class _AdminAllRequestsWidgetState extends State<AdminAllRequestsWidget> {
  late AdminAllRequestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAllRequestsModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.ridesQuery = await queryRidesRecordOnce(
        queryBuilder: (ridesRecord) => ridesRecord.orderBy('date'),
      );
      _model.requestQuery = _model.ridesQuery!.toList().cast<RidesRecord>();
    ...
    return StreamBuilder<List<RidesRecord>>(
      stream: queryRidesRecord(
        queryBuilder: (ridesRecord) =>
            ridesRecord.orderBy('date', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<RidesRecord> adminAllRequestsRidesRecordList = snapshot.data!;
                                      ...
                                      children: [
                                                                        ...
                                                                        () async {
                                                                          safeSetState(
                                                                            ...
                                                                            _model.simpleSearchResults1 =
                                                                                TextSearch((_model.ridesQuery!.map((e) => e.status).toList() as List).cast<String>().map((str) => TextSearchItem.fromTerms(str, [str])).toList()).search(_model.textController1.text).map((r) => r.object).toList();
                                                                            ;
                                                                          });
                                                                          _model.searchedRides = _model
                                                                              .ridesQuery!
                                                                              .where((e) => _model.simpleSearchResults1.contains(e.status))
                                                                              .toList()
                                                                              .cast<RidesRecord>();
                                                                          safeSetState(
                                                                              () {});
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onFieldSubmitted:
                                                                      ...
                                                                      safeSetState(
                                                                          () {
                                                                        _model
                                                                            .simpleSearchResults2 = TextSearch((List.generate(
                                        ...
                                        Expanded(
                                          child: Builder(
                                            builder: (context) {
                                              final ridestest =
                                                  adminAllRequestsRidesRecordList
                                                      .toList();
