...
import '/index.dart';
import 'dispatcher_user_management_widget.dart'
...
class DispatcherUserManagementModel
    extends FlutterFlowModel<DispatcherUserManagementWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in dispatcher-user_management widget.
