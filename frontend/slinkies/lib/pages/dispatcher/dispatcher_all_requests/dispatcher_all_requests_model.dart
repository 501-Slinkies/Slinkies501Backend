...
import '/index.dart';
import 'dispatcher_all_requests_widget.dart' show DispatcherAllRequestsWidget;
...
class DispatcherAllRequestsModel
    extends FlutterFlowModel<DispatcherAllRequestsWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in dispatcher-all_requests widget.
  ...
  List<RidesRecord> simpleSearchResults1 = [];
  List<RidesRecord> simpleSearchResults2 = [];
  ...
  List<String> simpleSearchResults3 = [];
  // State field(s) for DropDown widget.
