...
import 'admin_calendar_unassigned_model.dart';
export 'admin_calendar_unassigned_model.dart';

class AdminCalendarUnassignedWidget extends StatefulWidget {
  const AdminCalendarUnassignedWidget({super.key});

  static String routeName = 'admin-calendar-unassigned';
  static String routePath = '/admin-calendar-unassigned';

  @override
  State<AdminCalendarUnassignedWidget> createState() =>
      _AdminCalendarUnassignedWidgetState();
}

class _AdminCalendarUnassignedWidgetState
    extends State<AdminCalendarUnassignedWidget> {
  late AdminCalendarUnassignedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCalendarUnassignedModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final adminCalendarUnassignedGetCalendarInfoResponse = snapshot.data!;
                                        ...
                                        Container(
                                          ...
                                          child: custom_widgets
                                            ...
                                            apiEventList: GetCalendarInfoCall
                                                    .ridesList(
                                              adminCalendarUnassignedGetCalendarInfoResponse
                                                  .jsonBody,
                                            )!
                                                .where((e) =>
