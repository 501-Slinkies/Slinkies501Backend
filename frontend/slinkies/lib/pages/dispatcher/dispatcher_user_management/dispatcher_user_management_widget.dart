...
import 'dispatcher_user_management_model.dart';
export 'dispatcher_user_management_model.dart';

class DispatcherUserManagementWidget extends StatefulWidget {
  const DispatcherUserManagementWidget({super.key});

  static String routeName = 'dispatcher-user_management';
  static String routePath = '/dispatcherUserManagement';

  @override
  State<DispatcherUserManagementWidget> createState() =>
      _DispatcherUserManagementWidgetState();
}

class _DispatcherUserManagementWidgetState
    extends State<DispatcherUserManagementWidget>
    with TickerProviderStateMixin {
  late DispatcherUserManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherUserManagementModel());
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: NavButtonWidget(
                                  ...
                                  destination: () async {
                                    context.pushNamed(
                                      DispatcherUserManagementWidget.routeName,
                                      extra: <String, dynamic>{
                                        kTransitionInfoKey: TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
                                ...
                                children: [
                                  ...
                                  wrapWithModel(
                                    ...
                                    child: NavButtonWidget(
                                      ...
                                      destination: () async {
                                        context.pushNamed(
                                          DispatcherUserManagementWidget
                                              .routeName,
                                          extra: <String, dynamic>{
                                            kTransitionInfoKey: TransitionInfo(
                                              hasTransition: true,
