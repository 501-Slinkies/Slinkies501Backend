...
import 'driver_completemyrides_model.dart';
export 'driver_completemyrides_model.dart';

/// Admin main menu page
///
class DriverCompletemyridesWidget extends StatefulWidget {
  const DriverCompletemyridesWidget({super.key});

  static String routeName = 'driver-completemyrides';
  static String routePath = '/driverCompletemyrides';

  @override
  State<DriverCompletemyridesWidget> createState() =>
      _DriverCompletemyridesWidgetState();
}

class _DriverCompletemyridesWidgetState
    extends State<DriverCompletemyridesWidget> {
  late DriverCompletemyridesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverCompletemyridesModel());
      ...
      builder: (context) => StreamBuilder<List<RidesRecord>>(
        stream: queryRidesRecord(
          queryBuilder: (ridesRecord) => ridesRecord
              .where(
                'driverUID',
                isEqualTo: valueOrDefault(currentUserDocument?.volunteerId, ''),
              )
              .where(
                'status',
        ...
        builder: (context, snapshot) {
          ...
          List<RidesRecord> driverCompletemyridesRidesRecordList =
              snapshot.data!;
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Builder(
                                                builder: (context) {
                                                  final getRides =
                                                      driverCompletemyridesRidesRecordList
                                                          .toList();
                                                        ...
                                                        wrapWithModel(
                                                          ...
                                                          updateCallback: () =>
                                                              safeSetState(
                                                                  () {}),
                                                          child:
                                                              TotalMilesTextfieldWidget(
                                                            key: Key(
                                                              'Keynjd_${'${getRidesItem.uid}'}',
                                                            ),
                                                          ),
                                                        ),
                                                        wrapWithModel(
                                                          ...
                                                          updateCallback: () =>
                                                              safeSetState(
                                                                  () {}),
                                                          child:
                                                              TotalHoursTextFieldWidget(
                                                            key: Key(
                                                              'Keyimt_${'${getRidesItem.uid}'}',
                                                            ),
                                                          ),
                                                        ),
                                                        wrapWithModel(
                                                          ...
                                                          updateCallback: () =>
                                                              safeSetState(
                                                                  () {}),
                                                          child:
                                                              DonationsRecievedTextFieldWidget(
                                                            key: Key(
                                                              'Keyphh_${'${getRidesItem.uid}'}',
                                                            ),
                                                          ),
                                                        ),
                                                        wrapWithModel(
                                                          ...
                                                          updateCallback: () =>
                                                              safeSetState(
                                                                  () {}),
                                                          child:
                                                              DonationAmountTextFieldWidget(
                                                            key: Key(
                                                              'Key1fg_${'${getRidesItem.uid}'}',
                                                            ),
                                                          ),
                                                        ),
                                                        Row(
                                                          ...
                                                          children: [
                                                              ...
                                                              child: Container(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  color: _model
                                                                          .completionEntries
                                                                          .contains(
                                                                              '${getRidesItem.uid},${_model.totalMilesTextfieldModels.getValueForKey(
                                                                    '${getRidesItem.uid}',
                                                                    (m) => m
                                                                        .totalMilesTextController
                                                                        .text,
                                                                  )},${_model.totalHoursTextFieldModels.getValueForKey(
                                                                    getRidesItem
                                                                        .uid,
                                                                    (m) => m
                                                                        .totalHoursTextController
                                                                        .text,
                                                                  )},${_model.donationsRecievedTextFieldModels.getValueForKey(
                                                                    getRidesItem
                                                                        .uid,
                                                                    (m) => m
                                                                        .donationsRecievedTextController
                                                                        .text,
                                                                  )},${_model.donationAmountTextFieldModels.getValueForKey(
                                                                    getRidesItem
                                                                        .uid,
                                                                    (m) => m
                                                                        .donoAmountTextController
                                                                        .text,
                                                                  )}')
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                                                            ...
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                _model.removeFromCompletionEntries(
                                                                    '${getRidesItem.uid},${_model.totalMilesTextfieldModels.getValueForKey(
                                                                  '${getRidesItem.uid}',
                                                                  (m) => m
                                                                      .totalMilesTextController
                                            ...
                                            Align(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  if (_model.completionEntries
                                                      .isNotEmpty) {
                                                    _model.apiResultk72 =
                                                        await CompleteRidesCall
                                                            .call(
                                                      rideCompletions: functions
                                            ...
                                            Text(
                                              'Debug: ${functions.stringMerginator9000(_model.completionEntries.toList(), true)}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
