...
import 'dispatcher_drivers_model.dart';
export 'dispatcher_drivers_model.dart';

/// Admin main menu page
///
class DispatcherDriversWidget extends StatefulWidget {
  const DispatcherDriversWidget({super.key});

  static String routeName = 'dispatcher-drivers';
  static String routePath = '/dispatcher-drivers';

  @override
  State<DispatcherDriversWidget> createState() =>
      _DispatcherDriversWidgetState();
}

class _DispatcherDriversWidgetState extends State<DispatcherDriversWidget> {
  late DispatcherDriversModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherDriversModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VolunteersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VolunteersRecord> dispatcherDriversVolunteersRecordList =
            snapshot.data!;
                        ...
                        ListView(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                    DispatcherDriversWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 50.0,
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Builder(
                                            builder: (context) {
                                              final volunteers =
                                                  dispatcherDriversVolunteersRecordList
                                                      .toList();
