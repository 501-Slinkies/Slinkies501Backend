...
import 'admin_submit_unavailability_model.dart';
export 'admin_submit_unavailability_model.dart';

/// Admin main menu page
///
class AdminSubmitUnavailabilityWidget extends StatefulWidget {
  const AdminSubmitUnavailabilityWidget({super.key});

  static String routeName = 'admin-submit_unavailability';
  static String routePath = '/admin-submit-unavailability';

  @override
  State<AdminSubmitUnavailabilityWidget> createState() =>
      _AdminSubmitUnavailabilityWidgetState();
}

class _AdminSubmitUnavailabilityWidgetState
    extends State<AdminSubmitUnavailabilityWidget>
    with TickerProviderStateMixin {
  late AdminSubmitUnavailabilityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminSubmitUnavailabilityModel());
                                                                    ...
                                                                    AuthUserStreamWidget(
                                                                      builder: (context) =>
                                                                        ...
                                                                        future:
                                                                          ...
                                                                          volunteerId: valueOrDefault(
                                                                              currentUserDocument?.volunteerId,
                                                                              ''),
                                                                        ),
                                                                        builder:
                                                                            (context,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                            (context) {
                                                                          final volunteer =
                                                                              containerVolunteersRecordList.toList();
                                                                          ...
                                                                          return FlutterFlowDataTable<
                                                                            ...
                                                                            dataRowBuilder: (volunteerItem, volunteerIndex, selected, onSelectChanged) =>
                                                                                DataRow(
                                                                              color: MaterialStateProperty.all(
                                                                                volunteerIndex % 2 == 0 ? FlutterFlowTheme.of(context).secondaryBackground : FlutterFlowTheme.of(context).primaryBackground,
                                                                              ),
                                                                              cells: [
                                                                                Text(
                                                                                  volunteerItem.lastName,
                                                                                ...
                                                                                Text(
                                                                                  volunteerItem.driverAvailabilityByDayAndTime,
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        font: GoogleFonts.inter(
                                                                                          fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                          fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                            ...
                                                            return Container(
                                                              ...
                                                              child:
                                                                ...
                                                                optionsBuilder:
                                                                  ...
                                                                  return textFieldVolunteersRecordList
                                                                      .map((e) => e
                                                                          .lastName)
                                                                      .toList()
                                                                      .where(
                                                                    ...
                                                                    onChanged: (_) =>
                                                                      ...
                                                                      Duration(
                                                                          milliseconds:
                                                                              2000),
                                                                      () async {
                                                                        if (_model.textFieldSelectedOption !=
                                                                                null &&
                                                                            _model.textFieldSelectedOption !=
                                                                                '') {
                                                                          _model.gotRefCopy =
                                                                              await actions.getVolunteerRecord(
                                                                            '',
                                                                            _model.textFieldSelectedOption,
                                                                          );
                                                                          _model.voldoc =
                                                                              await VolunteersRecord.getDocumentOnce(_model.gotRefCopy!);
                                                                          _model.volunteerRef =
                                                                              _model.gotRefCopy;
                                                                          _model.volunteerDoc =
                                                                              _model.voldoc;
                                                      ...
                                                      Text(
                                                        _model.volunteerDoc !=
                                                                null
                                                            ? '${_model.volunteerDoc?.firstName},${_model.volunteerDoc?.lastName}'
                                                            : '',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
