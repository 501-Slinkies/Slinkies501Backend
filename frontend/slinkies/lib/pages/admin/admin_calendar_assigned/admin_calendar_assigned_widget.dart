...
import 'admin_calendar_assigned_model.dart';
export 'admin_calendar_assigned_model.dart';

class AdminCalendarAssignedWidget extends StatefulWidget {
  const AdminCalendarAssignedWidget({super.key});

  static String routeName = 'admin-calendar-assigned';
  static String routePath = '/admin-calendar-assigned';

  @override
  State<AdminCalendarAssignedWidget> createState() =>
      _AdminCalendarAssignedWidgetState();
}

class _AdminCalendarAssignedWidgetState
    extends State<AdminCalendarAssignedWidget> {
  late AdminCalendarAssignedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCalendarAssignedModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final adminCalendarAssignedGetCalendarInfoResponse = snapshot.data!;
                                        ...
                                        Container(
                                          ...
                                          child: custom_widgets
                                            ...
                                            apiEventList: GetCalendarInfoCall
                                                    .ridesList(
                                              adminCalendarAssignedGetCalendarInfoResponse
                                                  .jsonBody,
                                            )!
                                                .where((e) =>
