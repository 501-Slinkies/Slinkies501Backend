...
import '/index.dart';
import 'admin_calendar_complete_widget.dart' show AdminCalendarCompleteWidget;
...
class AdminCalendarCompleteModel
    extends FlutterFlowModel<AdminCalendarCompleteWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-calendar-complete widget.
