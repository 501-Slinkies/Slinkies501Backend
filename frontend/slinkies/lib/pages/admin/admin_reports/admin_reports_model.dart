...
class AdminReportsModel extends FlutterFlowModel<AdminReportsWidget> {
  ...
  List<String> variablesSelected = [];
  void addToVariablesSelected(String item) => variablesSelected.add(item);
  void removeFromVariablesSelected(String item) =>
      variablesSelected.remove(item);
  void removeAtIndexFromVariablesSelected(int index) =>
      variablesSelected.removeAt(index);
  void insertAtIndexInVariablesSelected(int index, String item) =>
      variablesSelected.insert(index, item);
  void updateVariablesSelectedAtIndex(int index, Function(String) updateFn) =>
      variablesSelected[index] = updateFn(variablesSelected[index]);

  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-reports widget.
  ...
  // State field(s) for DropDown-collection widget.
  String? dropDownCollectionValue;
  FormFieldController<String>? dropDownCollectionValueController;
  // Stores action output result for [Firestore Query - Query a collection] action in DropDown-collection widget.
  ClientsRecord? clientsQuery;
  // Stores action output result for [Firestore Query - Query a collection] action in DropDown-collection widget.
  List<VolunteersRecord>? volunteersQuery;
  // Stores action output result for [Firestore Query - Query a collection] action in DropDown-collection widget.
  ...
  // Stores action output result for [Backend Call - API (postReportType)] action in query-results-bttn widget.
  ApiCallResponse? postQueryselections;
