...
import 'driver_submit_time_model.dart';
export 'driver_submit_time_model.dart';

/// Admin main menu page
///
class DriverSubmitTimeWidget extends StatefulWidget {
  const DriverSubmitTimeWidget({super.key});

  static String routeName = 'driver-submit_time';
  static String routePath = '/driver-submit-time';

  @override
  State<DriverSubmitTimeWidget> createState() => _DriverSubmitTimeWidgetState();
}

class _DriverSubmitTimeWidgetState extends State<DriverSubmitTimeWidget>
    with TickerProviderStateMixin {
  late DriverSubmitTimeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverSubmitTimeModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MileageLogsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MileageLogsRecord> driverSubmitTimeMileageLogsRecordList =
            snapshot.data!;
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              await MileageLogsRecord.collection.doc().set(createMileageLogsRecordData(
                                                                                    uid: _model.userLoggedIn?.reference.id,
                                                                                    hours: double.tryParse(_model.textController2.text),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          builder:
                                                                              (context) {
                                                                            final mileage =
                                                                                driverSubmitTimeMileageLogsRecordList.toList();
