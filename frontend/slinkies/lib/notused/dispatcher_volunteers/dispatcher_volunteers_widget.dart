...
import 'dispatcher_volunteers_model.dart';
export 'dispatcher_volunteers_model.dart';

/// Admin main menu page
///
class DispatcherVolunteersWidget extends StatefulWidget {
  const DispatcherVolunteersWidget({super.key});

  static String routeName = 'dispatcher-volunteers';
  static String routePath = '/dispatcher-volunteers';

  @override
  State<DispatcherVolunteersWidget> createState() =>
      _DispatcherVolunteersWidgetState();
}

class _DispatcherVolunteersWidgetState
    extends State<DispatcherVolunteersWidget> {
  late DispatcherVolunteersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherVolunteersModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ClientsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClientsRecord> dispatcherVolunteersClientsRecordList =
            snapshot.data!;
                        ...
                        ListView(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                    DispatcherVolunteersWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 50.0,
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Builder(
                                                        builder: (context) {
                                                          final clients =
                                                              dispatcherVolunteersClientsRecordList
                                                                  .toList();
