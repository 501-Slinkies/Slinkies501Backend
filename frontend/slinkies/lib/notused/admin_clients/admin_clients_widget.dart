...
class AdminClientsWidget extends StatefulWidget {
  ...
  static String routeName = 'admin-clients';
  static String routePath = '/admin-clients';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ClientsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClientsRecord> adminClientsClientsRecordList = snapshot.data!;
