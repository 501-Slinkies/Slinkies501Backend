...
DocumentReference? get currentUserReference =>
    loggedIn ? VolunteersRecord.collection.doc(currentUser!.uid) : null;

VolunteersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : VolunteersRecord.getDocument(VolunteersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
