...
import 'driver_calendar_model.dart';
export 'driver_calendar_model.dart';

class DriverCalendarWidget extends StatefulWidget {
  const DriverCalendarWidget({super.key});

  static String routeName = 'driver-calendar';
  static String routePath = '/driver-calendar';

  @override
  State<DriverCalendarWidget> createState() => _DriverCalendarWidgetState();
}

class _DriverCalendarWidgetState extends State<DriverCalendarWidget> {
  late DriverCalendarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverCalendarModel());
  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => FutureBuilder<ApiCallResponse>(
        future: GetDriverAssignedRidesCall.call(
          driverID: valueOrDefault(currentUserDocument?.volunteerId, ''),
        ),
        builder: (context, snapshot) {
          ...
          final driverCalendarGetDriverAssignedRidesResponse = snapshot.data!;
                                            ...
                                            child: custom_widgets
                                              ...
                                              todaycolor:
                                                  FlutterFlowTheme.of(context)
                                                      .primary,
                                              apiEventList:
                                                  GetDriverAssignedRidesCall
                                                      .rides(
                                                driverCalendarGetDriverAssignedRidesResponse
                                                    .jsonBody,
                                              )!,
                                              rebuildpage: () async {},
