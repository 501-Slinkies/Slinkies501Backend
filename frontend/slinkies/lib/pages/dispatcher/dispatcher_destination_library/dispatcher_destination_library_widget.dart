...
import 'dispatcher_destination_library_model.dart';
export 'dispatcher_destination_library_model.dart';

///
///
class DispatcherDestinationLibraryWidget extends StatefulWidget {
  const DispatcherDestinationLibraryWidget({super.key});

  static String routeName = 'dispatcher-destination_library';
  static String routePath = '/dispatche-destination_library';

  @override
  State<DispatcherDestinationLibraryWidget> createState() =>
      _DispatcherDestinationLibraryWidgetState();
}

class _DispatcherDestinationLibraryWidgetState
    extends State<DispatcherDestinationLibraryWidget> {
  late DispatcherDestinationLibraryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherDestinationLibraryModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.destQuery = await queryDestinationRecordOnce();
      _model.destinationsList = _model.destQuery!
          .map((e) => e.reference)
          .toList()
          .toList()
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<DestinationRecord>>(
      stream: queryDestinationRecord(),
      builder: (context, snapshot) {
        ...
        List<DestinationRecord>
            dispatcherDestinationLibraryDestinationRecordList = snapshot.data!;
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  ...
                                  child: NavButtonWidget(
                                    ...
                                    destination: () async {
                                      context.pushNamed(
                                          DispatcherDestinationLibraryWidget
                                              .routeName);
                                    },
                                  ),
                                ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        ...
                                                                        () async {
                                                                          safeSetState(
                                                                            ...
                                                                            _model.simpleSearchResults =
                                                                                TextSearch(
                                                                              dispatcherDestinationLibraryDestinationRecordList
                                                                                  .map(
                                                                          ...
                                                                          _model.destinationsList = _model
                                                                              .simpleSearchResults
                                                                              .map((e) => e.reference)
                                                                              .toList()
                                                                              .cast<DocumentReference>();
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        hintText:
                                                                            'Search Destination by Name or Address',
