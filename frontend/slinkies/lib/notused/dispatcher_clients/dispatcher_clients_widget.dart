...
import 'dispatcher_clients_model.dart';
export 'dispatcher_clients_model.dart';

/// Admin main menu page
///
class DispatcherClientsWidget extends StatefulWidget {
  const DispatcherClientsWidget({super.key});

  static String routeName = 'dispatcher-clients';
  static String routePath = '/dispatcher-clients';

  @override
  State<DispatcherClientsWidget> createState() =>
      _DispatcherClientsWidgetState();
}

class _DispatcherClientsWidgetState extends State<DispatcherClientsWidget> {
  late DispatcherClientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatcherClientsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ClientsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClientsRecord> dispatcherClientsClientsRecordList = snapshot.data!;
                        ...
                        ListView(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                    DispatcherClientsWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 50.0,
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Builder(
                                                            builder: (context) {
                                                              final client =
                                                                  dispatcherClientsClientsRecordList
                                                                      .toList();
