...
import 'super_admin_neworg_model.dart';
export 'super_admin_neworg_model.dart';

/// Admin main menu page
///
class SuperAdminNeworgWidget extends StatefulWidget {
  const SuperAdminNeworgWidget({super.key});

  static String routeName = 'super-admin-neworg';
  static String routePath = '/superadmin-dashboard-neworg';

  @override
  State<SuperAdminNeworgWidget> createState() => _SuperAdminNeworgWidgetState();
}

class _SuperAdminNeworgWidgetState extends State<SuperAdminNeworgWidget> {
  late SuperAdminNeworgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuperAdminNeworgModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.apiResultppk = await GetRolesCall.call(
        orgId: FFAppState().orgID,
      );

      if ((_model.apiResultppk?.succeeded ?? true)) {
        _model.secRoles = GetRolesCall.roleView(
          (_model.apiResultppk?.jsonBody ?? ''),
        )!
            .toList()
            .cast<String>();
        safeSetState(() {});
    ...
    _model.textFieldPcTokenTextController ??= TextEditingController();
    _model.textFieldPcTokenFocusNode ??= FocusNode();
    ...
    _model.textFieldScTokenTextController ??= TextEditingController();
    _model.textFieldScTokenFocusNode ??= FocusNode();
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(SuperAdminNeworgWidget.routeName);
                          },
                          child: Container(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  ...
                                  child: NavButtonWidget(
                                    ...
                                    destination: () async {
                                      context.pushNamed(
                                          SuperAdminAuditLogWidget.routeName);
                                    },
                                  ),
                                ),
                              ].divide(SizedBox(height: 10.0)),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Align(
                                    alignment: AlignmentDirectional(-1.0, 0.0),
                                    child: Text(
                                      'Add a new organization to the system with complete details and contact information',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                                                              ...
                                                              Align(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model
                                                                            .textFieldPcTokenTextController,
                                                                    focusNode:
                                                                        _model
                                                                            .textFieldPcTokenFocusNode,
                                                                    autofocus:
                                                                        false,
                                                                    obscureText:
                                                                        !_model
                                                                            .textFieldPcTokenVisibility,
                                                                    decoration:
                                                                        InputDecoration(
                                                                      isDense:
                                                                          true,
                                                                      ...
                                                                      suffixIcon:
                                                                        ...
                                                                        onTap: () =>
                                                                            safeSetState(
                                                                          () => _model.textFieldPcTokenVisibility =
                                                                              !_model.textFieldPcTokenVisibility,
                                                                        ),
                                                                        focusNode:
                                                              ...
                                                              Align(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        _model
                                                                            .textFieldScTokenTextController,
                                                                    focusNode:
                                                                        _model
                                                                            .textFieldScTokenFocusNode,
                                                                    autofocus:
                                                                        false,
                                                                    obscureText:
                                                                        !_model
                                                                            .textFieldScTokenVisibility,
                                                                    decoration:
                                                                        InputDecoration(
                                                                      isDense:
                                                                          true,
                                                                      ...
                                                                      suffixIcon:
                                                                        ...
                                                                        onTap: () =>
                                                                            safeSetState(
                                                                          () => _model.textFieldScTokenVisibility =
                                                                              !_model.textFieldScTokenVisibility,
                                                                        ),
                                                                        focusNode:
                                                                            FocusNode(skipTraversal: true),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                _model.newOrgCreated =
                                                    await CreateOrgCall.call(
                                                  shortName: _model
                                                  ...
                                                  scAddress2: _model
                                                      .textController24.text,
                                                  scCity: _model
                                                      .textController25.text,
                                                  scState: _model
                                                      .textController26.text,
                                                  scZip: _model
                                                      .textController27.text,
                                                  scSecurityRole: _model
                                                      .dropDownScRoleValue,
                                                  scToken: _model
                                                      .textFieldScTokenTextController
                                                      .text,
                                                  pcSeurityRole: _model
                                                      .dropDownPcRoleValue,
                                                  pcToken: _model
                                                      .textFieldPcTokenTextController
                                                      .text,
