...
import 'admin_calllogs_model.dart';
export 'admin_calllogs_model.dart';

/// Admin main menu page
///
class AdminCalllogsWidget extends StatefulWidget {
  const AdminCalllogsWidget({super.key});

  static String routeName = 'admin-calllogs';
  static String routePath = '/admin-calllogs';

  @override
  State<AdminCalllogsWidget> createState() => _AdminCalllogsWidgetState();
}

class _AdminCalllogsWidgetState extends State<AdminCalllogsWidget> {
  late AdminCalllogsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCalllogsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CalllogsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CalllogsRecord> adminCalllogsCalllogsRecordList = snapshot.data!;
                                                                        ...
                                                                        () async {
                                                                          safeSetState(
                                                                            ...
                                                                            _model.simpleSearchResults1 =
                                                                                TextSearch(
                                                                              adminCalllogsCalllogsRecordList
                                                                                  .map(
