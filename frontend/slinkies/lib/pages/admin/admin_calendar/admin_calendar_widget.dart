...
import 'admin_calendar_model.dart';
export 'admin_calendar_model.dart';

class AdminCalendarWidget extends StatefulWidget {
  const AdminCalendarWidget({super.key});

  static String routeName = 'admin-calendar';
  static String routePath = '/admin-calendarr';
...
class _AdminCalendarWidgetState extends State<AdminCalendarWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().userLoggedIn = _model.userLoggedIn?.reference;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final adminCalendarGetCalendarInfoResponse = snapshot.data!;
                                          ...
                                          child: custom_widgets
                                            ...
                                            todaycolor:
                                                FlutterFlowTheme.of(context)
                                                    .primary,
                                            apiEventList:
                                                GetCalendarInfoCall.ridesList(
                                              adminCalendarGetCalendarInfoResponse
                                                  .jsonBody,
                                            )!,
                                            rebuildpage: () async {},
                                            actionAfterChange: () async {
                                              if (FFAppState()
                                                  .currentMeeting
                                                  .hasId()) {
                                                _model.tappedRideDocument =
                                                    await queryRidesRecordOnce(
                                                  singleRecord: true,
                                                ).then((s) => s.firstOrNull);
                                                _model.tappedRide =
                                                    _model.tappedRideDocument;
                                              ...
                                              if (_model.tappedRide != null) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                  SnackBar(
                                                    content: Text(
                                                      'Ride tapped: ${FFAppState().currentMeeting.id?.id}',
                                                      style: TextStyle(
                                                        color: FlutterFlowTheme
                                                                .of(context)
                                                            .secondaryBackground,
