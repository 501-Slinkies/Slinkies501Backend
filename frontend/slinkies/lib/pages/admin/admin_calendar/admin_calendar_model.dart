...
import '/index.dart';
import 'admin_calendar_widget.dart' show AdminCalendarWidget;
...
class AdminCalendarModel extends FlutterFlowModel<AdminCalendarWidget> {
  ///  Local state fields for this page.

  RidesRecord? tappedRide;

  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-calendar widget.
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in SyncfusionCalendarWidget widget.
  RidesRecord? tappedRideDocument;
