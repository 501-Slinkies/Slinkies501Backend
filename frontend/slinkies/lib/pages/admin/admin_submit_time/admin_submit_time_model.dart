...
import '/index.dart';
import 'admin_submit_time_widget.dart' show AdminSubmitTimeWidget;
...
class AdminSubmitTimeModel extends FlutterFlowModel<AdminSubmitTimeWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in admin-submit_time widget.
